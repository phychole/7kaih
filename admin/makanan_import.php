...
<h3 class="mb-4"><i class="fas fa-upload"></i> Import Jenis Makanan (CSV)</h3>

<div class="alert alert-info">
Format CSV harus seperti:<br>
<code>nama</code><br>
Contoh:<br>
<code>Sayur Bayam<br>Buah Pisang<br>Air Putih</code>
</div>

<div class="card shadow">
<div class="card-body">

<form action="makanan_import_proses.php" method="POST" enctype="multipart/form-data">
