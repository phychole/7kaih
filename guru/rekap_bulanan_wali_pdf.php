...
<head>
<meta charset="utf-8">
<title>Rekap Bulanan (Siswa Wali) <?= htmlspecialchars($judulBulan) ?></title>
<style>
...
<div class="header">
  <h2>Rekap Bulanan Jurnal 7 Kebiasaan (Siswa Wali)</h2>
  <div class="meta">
...
<table>
  <thead>
    <tr>
      ...
      <th rowspan="2" style="width:120px;">Kelas</th>
  ...
  <tbody>
    <?php if ($data->num_rows == 0): ?>
      <tr><td colspan="14" class="center">Tidak ada data.</td></tr>
    <?php endif; ?>
    ...
    ?>
      <tr>
        ...
        <td class="center"><?= $ib_lengkap ?> / <?= $ib_ada ?></td>
        <td class="center"><?= $mk_lengkap ?> / <?= $mk_ada ?></td>
      </tr>
    <?php endwhile; ?>
  </tbody>
</table>
